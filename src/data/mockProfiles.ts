...
export const mockProfiles: UserProfile[] = [
  {
    ...
    skills: [
      createSkill('pm', 'expert'),
      createSkill('ux-research', 'expert'),
      createSkill('analytics', 'intermediate'),
      createSkill('agile', 'expert'),
    ],
    wantedSkills: [
      createWantedSkill('backend', 'must-have'),
      createWantedSkill('frontend', 'must-have'),
      createWantedSkill('growth', 'nice-to-have'),
    ],
    role: 'product',
  ...
  },
  {
    ...
    skills: [
      ...
      createSkill('data', 'intermediate'),
    ],
    wantedSkills: [
      createWantedSkill('sales', 'must-have'),
      createWantedSkill('strategy', 'must-have'),
  ...
  },
  {
    ...
    skills: [
      createSkill('growth', 'expert'),
      createSkill('seo', 'expert'),
      createSkill('content', 'intermediate'),
      createSkill('analytics', 'intermediate'),
    ],
    wantedSkills: [
      createWantedSkill('frontend', 'must-have'),
      createWantedSkill('backend', 'must-have'),
      createWantedSkill('pm', 'nice-to-have'),
    ],
    role: 'marketing',
  ...
  },
  {
    ...
    skills: [
      ...
      createSkill('strategy', 'expert'),
      createSkill('finance', 'intermediate'),
    ],
    wantedSkills: [
      createWantedSkill('backend', 'must-have'),
      createWantedSkill('frontend', 'must-have'),
      createWantedSkill('pm', 'must-have'),
    ],
    role: 'business',
    availability: 'full-time',
    ambition: 'unicorn',
  ...
  },
  {
    ...
    skills: [
      createSkill('ui', 'expert'),
      createSkill('ux', 'expert'),
      createSkill('graphic', 'expert'),
      createSkill('motion', 'intermediate'),
    ],
    wantedSkills: [
      createWantedSkill('frontend', 'must-have'),
      createWantedSkill('backend', 'must-have'),
      createWantedSkill('strategy', 'nice-to-have'),
    ],
    role: 'product',
